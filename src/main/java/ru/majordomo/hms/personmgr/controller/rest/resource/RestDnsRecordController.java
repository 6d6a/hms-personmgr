...
@Validated
public class RestDnsRecordController extends CommonRestResourceController {
    private final static Logger logger = LoggerFactory.getLogger(RestDnsRecordController.class);
