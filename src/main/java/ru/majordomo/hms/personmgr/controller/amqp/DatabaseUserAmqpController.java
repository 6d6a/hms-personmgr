...
@EnableRabbit
@Service
public class DatabaseUserAmqpController {

    private final static Logger logger = LoggerFactory.getLogger(DatabaseUserAmqpController.class);

    private final BusinessFlowDirector businessFlowDirector;

    @Autowired
    public DatabaseUserAmqpController(BusinessFlowDirector businessFlowDirector) {
