...
@EnableRabbit
@Service
public class DnsRecordAmqpController {

    private final static Logger logger = LoggerFactory.getLogger(DnsRecordAmqpController.class);

    private final BusinessFlowDirector businessFlowDirector;

    @Autowired
    public DnsRecordAmqpController(BusinessFlowDirector businessFlowDirector) {
