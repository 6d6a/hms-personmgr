...
public class SslCertificateAmqpController extends CommonAmqpController {
    ...
    public void create(@Payload SimpleServiceMessage message, @Headers Map<String, String> headers) {
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("Got Exception in ru.majordomo.hms.personmgr.controller.amqp.SslCertificateAmqpController.create " + e.getMessage());
        }
    }
    ...
    public void update(@Payload SimpleServiceMessage message, @Headers Map<String, String> headers) {
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("Got Exception in ru.majordomo.hms.personmgr.controller.amqp.SslCertificateAmqpController.update " + e.getMessage());
        }
    }
    ...
    public void delete(@Payload SimpleServiceMessage message, @Headers Map<String, String> headers) {
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("Got Exception in ru.majordomo.hms.personmgr.controller.amqp.SslCertificateAmqpController.delete " + e.getMessage());
        }
    }
}
