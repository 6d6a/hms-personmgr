...
public class CacheConfig extends CachingConfigurerSupport {
    ...
    public CacheManager cacheManager() {
        ...
        cacheManager.setCaches(Arrays.asList(
                ...
                new ConcurrentMapCache("servicePlansByPaymentServiceId"),
                new ConcurrentMapCache("oneServicePlanByFeature"),
                new ConcurrentMapCache("servicePlansByActive"),
                new ConcurrentMapCache("oneServicePlanByFeatureAndActive"),
                new ConcurrentMapCache("oneServicePlanByFeatureAndServiceId"),
